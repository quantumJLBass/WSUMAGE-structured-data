 ...
 **/
//class Wsu_StructuredData_Block_Datadump extends Mage_Core_Block_Template
class Wsu_StructuredData_Block_Datadump extends Mage_Catalog_Block_Product_Abstract {
    // Helper
    public $rdffClassName = "structureddata/Rdfformat";
    ...
    protected function initProductCollection() {
        ...
        $this->ProductCollection = Mage::getModel('catalog/product')->setStoreId($storeId)->getCollection()->addAttributeToFilter("visibility", $visibility)->addAttributeToFilter('status', 1)->addAttributeToSelect(array(
            'name',
            'small_image',
            'visibility',
            'is_saleable',
