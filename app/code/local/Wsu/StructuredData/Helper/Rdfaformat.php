...
**/
class Wsu_StructuredData_Helper_Rdfaformat extends Wsu_StructuredData_Helper_AbstractFormat
{
	...
	public function startRdfa($legalname, $tag = "div")
	{
		...
		#$code .= '<div property="dc:creator" datatype="xsd:string" content="StructuredData Magento Extension 0.9.9"></div>'."\n";
