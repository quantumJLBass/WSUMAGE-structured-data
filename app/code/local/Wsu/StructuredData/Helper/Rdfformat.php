<?php
class Wsu_StructuredData_Helper_Rdfformat extends Wsu_StructuredData_Helper_AbstractFormat {
    ...
    public function startRdfa($legalname, $tag = "rdf:RDF") {
        ...
        */
        ...
        $code .= '<dc:creator rdf:datatype="http://www.w3.org/2001/XMLSchema#string">StructuredData Magento Extension 0.9.9</dc:creator>' . "\n";
